...
### 🪟 Windows — 3 Easy Steps

**Step 1: Download the App Folder**
- Click on [FlashYT Releases](https://github.com/aazannoorkhuwaja/FlashYT/releases/latest).
- Scroll down and download the **`Source code (zip)`**.
...
- Click the **Load unpacked** button and select the `extension` folder found inside the ZIP you just extracted.
- The FlashYT icon will pop up in your toolbar!

**Step 3: Run the Setup Installer**
- Head back to the [FlashYT Releases](https://github.com/aazannoorkhuwaja/FlashYT/releases/latest) page.
...
### 🍎 macOS & 🐧 Linux — 2 Easy Steps

**Step 1: Add it to your Browser**
- Follow Windows Steps 1 and 2 above to load the extension folder into your browser.
